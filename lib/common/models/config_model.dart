...
class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    demo = json['demo'];
    maintenanceMode = json['maintenance_mode'] == true || _platformMaintenanceActive(json, 'user_app');
...
bool _platformMaintenanceActive(Map<String, dynamic> json, String surface) {
  final platform = json['platform_maintenance'];
  if (platform is! Map) return false;

  bool active(dynamic value) => value is Map && value['status'] == true;
  return active(platform['all']) || active(platform[surface]);
}
