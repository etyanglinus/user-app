...
import 'package:fasta_deliveries/common/widgets/corner_banner/banner.dart';
import 'package:fasta_deliveries/common/widgets/corner_banner/corner_discount_tag.dart';
import 'package:fasta_deliveries/common/widgets/custom_asset_image_widget.dart';
import 'package:fasta_deliveries/common/widgets/custom_favourite_widget.dart';
                      ...
                      Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                            ...
                            isStore ? store?.verifiedSeller == 1 ? Image.asset(Images.verifiedBadge, width: 16, height: 16) : SizedBox.shrink() : SizedBox.shrink(),
                          ...
                          inStore ? const SizedBox() : (isStore ? store!.address != null : item!.storeName != null) ? Row(
                            children: [
                              ...
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                              !isStore && item!.verifiedSeller == 1 ? Image.asset(Images.verifiedBadge, width: 12, height: 12) : SizedBox.shrink(),
                            ],
                          ) : const SizedBox(),
