...
import 'package:fasta_deliveries/features/home/widgets/unlock_module_tap.dart';
        ...
        widget.splashController.moduleList != null
            ? widget.splashController.moduleList!.isNotEmpty
                  ? ReorderableGridView.builder(
                      ...
                      dragStartDelay: const Duration(milliseconds: 350),
                      ...
                      onReorder: (oldIndex, newIndex) {
                        final modules = widget.splashController.moduleList;
                        if (modules == null || oldIndex == newIndex) {
                          return;
                        }
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ReorderableDelayedDragStartListener(
                          ...
                          index: index,
                          child: UnlockModuleTap(
                            borderRadius: BorderRadius.circular(
                              Dimensions.radiusDefault,
                            ),
                            onTap: () => widget.splashController.switchModule(
                              index,
                              true,
                            ),
                            child: Container(
