                                        ...
                                        Container(
                                          ...
                                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                            ...
                                            Expanded(
                                              ...
                                              child: Row(
                                                children: [
                                                  Text(storeList[index].name!, style: robotoMedium, maxLines: 1, overflow: TextOverflow.ellipsis),
                                                  SizedBox(width: 8),
                                                  storeList[index].verifiedSeller == 1 ? Image.asset(Images.verifiedBadge, width: 16, height: 16) : SizedBox.shrink()
                                                ],
                                              ),
                                            ),
                                          ]),
