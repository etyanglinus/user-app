...
import 'package:fasta_deliveries/features/profile/widgets/profile_bg_widget.dart';
...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
      ...
      body: GetBuilder<ProfileController>(
        builder: (profileController) {
          ...
          if (profileController.userInfoModel != null &&
            ...
            _dobController.text =
                profileController.userInfoModel?.dateOfBirth ?? '';
          }
                          ...
                          child: SizedBox(
                            ...
                            child: Column(
                              children: [
                                ...
                                _buildDateOfBirthField(profileController),
                                const SizedBox(
                                  height: Dimensions.paddingSizeExtraOverLarge,
                                ),
  ...
  Future<void> _updateProfile({
    ...
    if (name.isEmpty) {
      ...
      String dateOfBirth = _dobController.text.trim();
      bool canSetDateOfBirth =
          (profileController.userInfoModel?.dateOfBirth == null ||
              profileController.userInfoModel!.dateOfBirth!.isEmpty) &&
      ...
      UpdateUserModel updatedUser = UpdateUserModel(
        ...
        buttonType: fromButton
            ...
            ? 'phone'
            : 'email',
        dateOfBirth: canSetDateOfBirth ? dateOfBirth : null,
      );
  ...
  Widget _buildDateOfBirthField(ProfileController profileController) {
    bool canEditDateOfBirth =
        profileController.userInfoModel?.dateOfBirth == null ||
        profileController.userInfoModel!.dateOfBirth!.isEmpty;

    return InkWell(
      onTap: canEditDateOfBirth ? _selectDateOfBirth : null,
      borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
      child: IgnorePointer(
        child: CustomTextField(
          titleText: canEditDateOfBirth
          ...
          isEnabled: canEditDateOfBirth,
          fromUpdateProfile: !canEditDateOfBirth,
          suffixChild: canEditDateOfBirth
              ? Icon(
  ...
  Future<void> _selectDateOfBirth() async {
    ...
    if (pickedDate != null) {
      _dobController.text = DateConverter.dateToDate(pickedDate);
      setState(() {});
    }
  }
}
