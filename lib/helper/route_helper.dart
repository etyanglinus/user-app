...
import 'package:fasta_deliveries/common/widgets/zone_warning_dialog.dart';
...
import 'package:fasta_deliveries/features/auth/screens/rider_registration_screen.dart';
import 'package:fasta_deliveries/features/brands/screens/brands_product_screen.dart';
import 'package:fasta_deliveries/features/brands/screens/brands_screen.dart';
import 'package:fasta_deliveries/features/business/screens/subscription_payment_screen.dart';
import 'package:fasta_deliveries/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:fasta_deliveries/features/chat/domain/models/order_chat_model.dart';
import 'package:fasta_deliveries/features/checkout/screens/digital_payment_failed_screen.dart';
import 'package:fasta_deliveries/features/home/screens/home_screen.dart';
import 'package:fasta_deliveries/features/splash/screens/qr_screen.dart';
import 'package:fasta_deliveries/features/item/screens/item_view_all_screen.dart';
import 'package:fasta_deliveries/features/language/controllers/language_controller.dart';
import 'package:fasta_deliveries/features/loyalty/screens/loyalty_screen.dart';
import 'package:fasta_deliveries/features/profile/domain/models/update_user_model.dart';
import 'package:fasta_deliveries/features/profile/screens/setting_page.dart';
import 'package:fasta_deliveries/features/refer_and_earn/screens/refer_and_earn_screen.dart';
import 'package:fasta_deliveries/features/splash/controllers/splash_controller.dart';
import 'package:fasta_deliveries/features/notification/domain/models/notification_body_model.dart';
import 'package:fasta_deliveries/features/address/domain/models/address_model.dart';
import 'package:fasta_deliveries/features/item/domain/models/basic_campaign_model.dart';
import 'package:fasta_deliveries/features/chat/domain/models/conversation_model.dart';
...
import 'package:fasta_deliveries/features/parcel/domain/models/parcel_category_model.dart';
import 'package:fasta_deliveries/features/store/domain/models/store_model.dart';
import 'package:fasta_deliveries/features/address/screens/add_address_screen.dart';
import 'package:fasta_deliveries/features/address/screens/address_screen.dart';
import 'package:fasta_deliveries/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:fasta_deliveries/features/auth/screens/sign_in_screen.dart';
import 'package:fasta_deliveries/features/auth/screens/sign_up_screen.dart';
import 'package:fasta_deliveries/features/auth/screens/store_registration_screen.dart';
import 'package:fasta_deliveries/features/category/screens/category_screen.dart';
import 'package:fasta_deliveries/features/location/screens/map_screen.dart';
import 'package:fasta_deliveries/features/store/screens/campaign_screen.dart';
import 'package:fasta_deliveries/features/store/widgets/all_store_web_view_widget.dart';
...
import 'package:fasta_deliveries/helper/shallow_route_helper.dart';
import 'package:fasta_deliveries/util/app_constants.dart';
import 'package:fasta_deliveries/util/html_type.dart';
import 'package:fasta_deliveries/common/widgets/custom_loader.dart';
import 'package:fasta_deliveries/common/widgets/image_viewer_screen.dart';
import 'package:fasta_deliveries/common/widgets/not_found.dart';
import 'package:fasta_deliveries/features/cart/screens/cart_screen.dart';
import 'package:fasta_deliveries/features/category/screens/category_item_screen.dart';
import 'package:fasta_deliveries/features/chat/screens/chat_screen.dart';
import 'package:fasta_deliveries/features/chat/screens/conversation_screen.dart';
import 'package:fasta_deliveries/features/checkout/screens/checkout_screen.dart';
import 'package:fasta_deliveries/features/payment/screens/offline_payment_screen.dart';
import 'package:fasta_deliveries/features/checkout/screens/order_successful_screen.dart';
import 'package:fasta_deliveries/features/payment/screens/payment_screen.dart';
import 'package:fasta_deliveries/features/payment/screens/payment_webview_screen.dart';
import 'package:fasta_deliveries/features/coupon/screens/coupon_screen.dart';
import 'package:fasta_deliveries/features/dashboard/screens/dashboard_screen.dart';
import 'package:fasta_deliveries/features/favourite/screens/favourite_screen.dart';
import 'package:fasta_deliveries/features/fasta_prime/screens/fasta_prime_screen.dart';
import 'package:fasta_deliveries/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:fasta_deliveries/features/item/screens/item_campaign_screen.dart';
import 'package:fasta_deliveries/features/item/screens/item_details_screen.dart';
import 'package:fasta_deliveries/features/item/screens/popular_item_screen.dart';
import 'package:fasta_deliveries/features/verification/screens/forget_pass_screen.dart';
import 'package:fasta_deliveries/features/verification/screens/new_pass_screen.dart';
import 'package:fasta_deliveries/features/verification/screens/verification_screen.dart';
import 'package:fasta_deliveries/features/html/screens/html_viewer_screen.dart';
import 'package:fasta_deliveries/features/interest/screens/interest_screen.dart';
import 'package:fasta_deliveries/features/language/screens/language_screen.dart';
import 'package:fasta_deliveries/features/location/screens/access_location_screen.dart';
import 'package:fasta_deliveries/features/location/screens/pick_map_screen.dart';
import 'package:fasta_deliveries/features/notification/screens/notification_screen.dart';
import 'package:fasta_deliveries/features/onboard/screens/onboarding_screen.dart';
import 'package:fasta_deliveries/features/order/screens/guest_track_order_screen.dart';
import 'package:fasta_deliveries/features/order/screens/order_details_screen.dart';
import 'package:fasta_deliveries/features/order/screens/order_screen.dart';
import 'package:fasta_deliveries/features/order/screens/order_tracking_screen.dart';
import 'package:fasta_deliveries/features/order/screens/refund_request_screen.dart';
import 'package:fasta_deliveries/features/parcel/screens/parcel_category_screen.dart';
import 'package:fasta_deliveries/features/parcel/screens/parcel_location_screen.dart';
import 'package:fasta_deliveries/features/parcel/screens/parcel_request_screen.dart';
import 'package:fasta_deliveries/features/profile/screens/profile_screen.dart';
import 'package:fasta_deliveries/features/profile/screens/update_profile_screen.dart';
import 'package:fasta_deliveries/features/store/screens/all_store_screen.dart';
import 'package:fasta_deliveries/features/store/screens/store_item_search_screen.dart';
import 'package:fasta_deliveries/features/store/screens/store_screen.dart';
import 'package:fasta_deliveries/features/review/screens/review_screen.dart';
import 'package:fasta_deliveries/features/search/screens/search_screen.dart';
import 'package:fasta_deliveries/features/splash/screens/splash_screen.dart';
import 'package:fasta_deliveries/features/support/screens/support_screen.dart';
import 'package:fasta_deliveries/features/update/screens/update_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:fasta_deliveries/features/wallet/screens/wallet_screen.dart';
import 'package:fasta_deliveries/features/ride_share_module/safety_alert/screens/safety_policy_screen.dart';
...
class RouteHelper {
  ...
  static const String fastaPrime = '/fasta-prime';
  ...
  static String getFastaPrimeRoute() => fastaPrime;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: fastaPrime, page: () => getRoute(const FastaPrimeScreen())),
